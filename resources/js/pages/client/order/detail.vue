        ...
        <vue-good-table
          ...
          <template slot="table-row" slot-scope="props">
            ...
            <div v-else-if="props.column.field == 'amount'" >
              <span v-if="step == 1"><input type="number" :min="0" @change="changedOrderAmount($event, props.index, props.row.id)" :value="props.row.ordered_amount" :max="parseInt(getValue('amount', props.row.id))" /></span>
	      <span v-if="step == 2"><input type="number" :min="0" @change="changedOrderAmount($event, props.index, props.row.id)" :value="props.row.ordered_amount" :max="parseInt(getValue('amount', props.row.id))" disabled /></span>          
            </div>
