  ...
  <div class="order__detail_container">
    ...
    <div class="client__info" v-if="!!quote">
      <div class="left">
        ...
        <p class="client_saki">{{ quote.name }} <span>御中</span></p>
        <p class="content">
        ...
        <section class="pdf-item">
          <div class="pdf_container">
            <div class="pdf_heading">
              <p class="contact_to">{{ quote.com_name }} {{ quote.department_name }}<br/>{{ quote.name }}御中</p>
              <div class="page_type">
                <p>見積書</p>
            ...
            <div class="order_detail_info">
              ...
              <div class="right">
                <div class="client_info border">
                  <p class="contact_to">{{ $store.getters['recipienter_auth/user'].name }}<br/>担当者：{{ quote.recipienter.owner }}<br/>メールアドレス：{{ $store.getters['recipienter_auth/user'].email }}</p>
